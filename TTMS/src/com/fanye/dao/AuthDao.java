...
public class AuthDao {
	...
	public JSONArray getAuthByParentId(Connection con,String parentId,String authIds)throws Exception{
		...
		while(re.next()){
			...
			jsonObject.put("id", re.getInt("authId"));
			jsonObject.put("text", re.getString("authName"));
			if(!hasChildren(con,re.getString("authId"),authIds)){
				jsonObject.put("state", "open");
			}else{
				jsonObject.put("state", re.getString("state"));
			}
			jsonObject.put("iconCls", re.getString("iconCls"));
			JSONObject attributeObject=new JSONObject();
			attributeObject.put("authPath", re.getString("authPath"));
	...
	public JSONArray getTreeGridAuthByParentId(Connection con,String parentId)throws Exception{
		...
		while(re.next()){
			...
			jsonObject.put("state", re.getString("state"));
			jsonObject.put("iconCls", re.getString("iconCls"));
			jsonObject.put("authPath", re.getString("authPath"));
			jsonObject.put("authDescription", re.getString("authDescription"));
			jsonArray.add(jsonObject);
		}
		return jsonArray;
	}
