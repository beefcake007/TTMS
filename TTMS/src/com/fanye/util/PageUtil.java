...
public class PageUtil {
	...
	public static String genPagation(String targetUrl,int customerId,int totalNum,int currentPage,int pageSize){
		int totalPage=totalNum%pageSize==0?totalNum/pageSize:totalNum/pageSize+1;
		StringBuffer pageCode=new StringBuffer();
		pageCode.append("<li><a href='"+targetUrl+"&page=1&customerId="+customerId+"'>首页</a></li>");
		if(currentPage==1){
			pageCode.append("<li class='disabled'><a href='#'>上一页</a></li>");			
		}else{
			pageCode.append("<li><a href='"+targetUrl+"&page="+(currentPage-1)+"&customerId="+customerId+"'>上一页</a></li>");			
		}
		...
		if(currentPage==totalPage){
			...
			pageCode.append("<li><a href='"+targetUrl+"&page="+(currentPage+1)+"&customerId="+customerId+"'>下一页</a></li>");		
		}
		pageCode.append("<li><a href='"+targetUrl+"&page="+totalPage+"&customerId="+customerId+"'>尾页</a></li>");
		return pageCode.toString();
	}
}
